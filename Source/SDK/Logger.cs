...
namespace PayPal
{
    ...
    internal abstract class InternalLogger
    {
        ...
        public Type DeclaringType { get { return this.declareType; } private set { this.declareType = value; } }

        private bool enable;
        public bool IsEnabled { get { return this.enable; } set { this.enable = value; } }
